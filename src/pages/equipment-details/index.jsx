		...
		const fetchEquipment = async () => {
			try {
				...
				const res = await fetch(
					`https://campgear-rental.onrender.com/api/equipment/${id}`,
				);
		...
		const fetchDetails = async () => {
			try {
				...
				const [instructionRes, specRes] = await Promise.all([
					fetch(
						`https://campgear-rental.onrender.com/api/instructions/${equipment.type}`,
					),
					fetch(
						`https://campgear-rental.onrender.com/api/specifications/${equipment.type}`,
					),
				]);
	...
	useEffect(() => {
		...
		const fetchProvider = async () => {
			try {
				...
				const res = await fetch(
					`https://campgear-rental.onrender.com/api/providers/${encodedBrand}`,
				);
